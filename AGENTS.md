...
- **AI 框架**: `petfishframework` (v0.1.2 Alpha) — Agent recipe (model + reasoning + tools + retriever)、event-sourced Session、MCP-first Tool contracts、Pass^k 可靠性度量
- **包管理**: uv 0.11.17
- **测试**: pytest
...
- 待项目代码成型后补充。当前已知：petfishframework 处于 Alpha (v0.1.2)，API 可能变动，升级前先看 CHANGELOG。
